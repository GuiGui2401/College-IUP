...
class ReportsController extends Controller
{
    ...
    {
        $workingYear = $this->getUserWorkingYear();
        $schoolName = "COLLÈGE BILINGUE DE LA POINTE";
    ...
    private function generateCollectionDetailsContent($reportData)
    {
        ...
        // Titres
        $html .= "<div>";
        $html .= "<h2 style='margin: 0; font-size: 24px; font-weight: bold;'>" . ($schoolSettings['school_name'] ?? 'COLLÈGE BILINGUE DE LA POINTE') . "</h2>";
    ...
    private function generateSchoolFeePaymentDetailsHtml($reportData)
    {
            ...
            <div class='header'>
                <div class='header-content'>
                    ...
                    <div class='school-info'>
                        <div class='school-name'>COLLÈGE BILINGUE DE LA POINTE</div>
        ...
        $html .= "</tbody>
            ...
            <div class='footer'>
                Document généré automatiquement le {$summary['generated_at']} - COLLÈGE BILINGUE DE LA POINTE
            </div>
        </body>
        </html>";
    ...
    private function generateSimpleClassSchoolFeesHtml($reportData)
    {
        ...
        $html .= "</head><body>";
        $html .= "<h2>COLLÈGE BILINGUE DE LA POINTE</h2>";
    ...
    private function generateRecoveryStatusPdfHtml($data)
    {
        ...
        $html .= "<div class='school-name'>COLLÈGE BILINGUE DE LA POINTE</div>";
        $html .= "<div class='info-line'>Tél.: 233 42 26 47</div>";
        $html .= "<div class='info-line'>Email: cbpouala@yahoo.fr</div>";
                ...
                <div class='header'>
                    <div class='header-row'>
                        ...
                        <div class='header-center'>
                                " . ($logoBase64 ? "<img src='{$logoBase64}' class='logo' alt='Logo'>" : "<div class='logo-text'>CBP</div>") . "
                        </div>
